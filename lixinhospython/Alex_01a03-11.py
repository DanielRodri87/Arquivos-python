...
# questao 01   { Um banco só empresta dinheiro para quem tem o salário maior que R$ 2000 e a idade maior que 18 anos. Se um jovem de 22 anos ganhando R$ 3500 for pedir empréstimo, o banco aceitará ou não? Expresse a resposta em um código.}
if escolha == 1:
    print('==='*8)
...
# questao 02 {Leia dois números e que pergunte qual operação o usuário deseja realizar: soma, subtração, divisão e multiplicação. Exiba o resultado da operação solicitada.}
elif escolha ==2:
        print('==='*8)
        operacao = int(input('Digite e escolha o numero para a operação 1-Soma, 2-Subtração, 3-Multiplicação, 4-Divisão '))
        if operacao ==1:
            print('==='*8)
 ...
 # questao 03   { Escreva um programa para analisar o financiamento bancário para compra de uma casa. O programa deve perguntar o valor da casa a comprar, o salário e a quantidade de anos a pagar. O valor da prestação mensal não pode ser superior a 30% do salário. Calcule o valor da prestação como sendo o valor da casa a comprar dividido pelo número de meses a pagar. De acordo com as informações inseridas, o programa deve dizer se o financiamento será aprovado ou não.}
elif escolha ==3:
    print('==='*8)
